      ...
      <PerfectScrollbar className="deznav-scroll">
        <MM className="metismenu" id="menu">
          <li className={`${deshBoard.includes(path) ? "mm-active" : ""}`}>
            ...
            <ul>
              ...
              <li>
                <Link
                  className={`${path === "order-details" ? "mm-active" : ""}`}
                  to="/order-details"
                >
                  Order Details
                </Link>
          ...
          <li className={`${app.includes(path) ? "mm-active" : ""}`}>
            <Link className="has-arrow ai-icon" to="#">
              ...
              <span className="nav-text">Appsss</span>
            </Link>
            <ul>
              <li>
                <Link
          ...
          <li className={`${categoria.includes(path) ? "mm-active" : ""}`}>
            ...
            <ul>
              <li>
                <Link
                  className={`${path === "categoria" ? "mm-active" : ""}`}
                  to="/categoria"
                >
                  Categoria
                </Link>
              ...
              <li>
                <Link
                  className={`${path === "categoria-form" ? "mm-active" : ""}`}
                  to="/categoria-form"
                >
                  Categoria Form
                </Link>
        ...
        <div className="plus-box">
          ...
          <p className="fs-14 font-w400">
            Manage your food <br />
            and beverages menus<i className="fas fa-arrow-right ms-3"></i>
          </p>
        </div>
        <div className="copyright">
          <p>
            <strong>Admin Inventario</strong> © 2022 All Rights Reserved
          </p>
          <p className="fs-12">
            Made with <span className="heart"></span> by Miguel
          </p>
        </div>
      </PerfectScrollbar>
    </div>
